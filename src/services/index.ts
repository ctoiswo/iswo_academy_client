...
export { default as learningPathCoursesService, learningPathCoursesService as learningPathCoursesApi } from './learning-path-courses-service'
...
export { default as enrollmentService, enrollmentService as enrollmentApi } from './enrollment-service'
export { default as sectionService, sectionService as sectionApi } from './section-service'
export { default as lessonService, lessonService as lessonApi } from './lesson-service'
export { default as profileService, profileService as profileApi } from './profile-service'
export { default as questionService, questionService as questionApi } from './question-service'
export { default as studentAssignmentService, studentAssignmentService as studentAssignmentApi } from './student-assignment-service'
export { default as wishlistService, wishlistService as wishlistApi } from './wishlist-service'
export { default as certificateTemplateService, certificateTemplateService as certificateTemplateApi } from './certificate-template-service'
