...
import { useLearningPathEnrollments, useDeleteLearningPathEnrollment } from '@/hooks/use-learning-path-enrollments'
...
export function LearningPathStudents() {
  ...
  const { data: enrollmentsData, isLoading: isLoadingEnrollments } = useLearningPathEnrollments(
    academySlug,
    learningPathSlug,
    { status: statusFilter }
  )
  const deleteEnrollment = useDeleteLearningPathEnrollment(academySlug, learningPathSlug)
  ...
  return (
    <div className="space-y-6">
      ...
      <AlertDialog open={enrollmentToDelete !== null} onOpenChange={(open) => !open && setEnrollmentToDelete(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>¿Estás seguro?</AlertDialogTitle>
            <AlertDialogDescription>
              Esta acción eliminará permanentemente la inscripción del estudiante de esta ruta de aprendizaje.
