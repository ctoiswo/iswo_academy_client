...
export function LearningPathSettings() {
  ...
  const updateMutation = useUpdateLearningPathSettings(
    academySlug,
    learningPathSlug
  )
        ...
        <CardContent className='space-y-4'>
          <div className='space-y-2'>
            ...
            <Input
              ...
              value={position}
              onChange={(e) =>
                handlePositionChange(parseInt(e.target.value) || 0)
              }
              className='w-32'
            />
            <p className='text-muted-foreground text-sm'>
        ...
        <CardContent className='space-y-3'>
          <div className='grid grid-cols-2 gap-4 text-sm'>
            ...
            <div>
              ...
              <p>
                {new Date(learningPath.created_at).toLocaleDateString('es-ES')}
              </p>
            </div>
            <div>
              ...
              <p>
                {new Date(learningPath.updated_at).toLocaleDateString('es-ES')}
              </p>
            </div>
          </div>
        </CardContent>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                ...
                la ruta de aprendizaje "{learningPath.title}".
                {learningPath.courses_count > 0 && (
                  <p className='text-destructive mt-2 font-medium'>
                    Advertencia: Esta ruta contiene {learningPath.courses_count}{' '}
                    curso(s). Los cursos no serán eliminados, pero se
                    desasociarán de esta ruta.
                  </p>
                )}
              </AlertDialogDescription>
            </AlertDialogHeader>
