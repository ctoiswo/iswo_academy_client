...
export function LearningPathAnalytics() {
  ...
  const { data: analytics, isLoading: isLoadingAnalytics } =
    useLearningPathAnalytics(academySlug, learningPathSlug)
      ...
      <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-4'>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-muted-foreground text-xs'>días para completar</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-muted-foreground text-xs'>abandonaron la ruta</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className='grid gap-6 md:grid-cols-2'>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Tendencia de inscripciones mensuales
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className='space-y-4'>
              <div className='flex items-center justify-between'>
                ...
                <span className='text-sm font-bold'>
                  {analytics.engagement_levels.very_active}%
                </span>
              </div>
              <div className='flex items-center justify-between'>
                ...
                <span className='text-sm font-bold'>
                  {analytics.engagement_levels.moderately_active}%
                </span>
              </div>
              <div className='flex items-center justify-between'>
                <span className='text-sm font-medium'>Poco Activos</span>
                <span className='text-sm font-bold'>
                  {analytics.engagement_levels.low_activity}%
                </span>
              </div>
            </div>
          </CardContent>
            ...
            {analytics.highest_dropout_course ? (
              <div className='space-y-2'>
                <p className='font-medium'>
                  {analytics.highest_dropout_course.course_title}
                </p>
                <p className='text-muted-foreground text-sm'>
                  {analytics.highest_dropout_course.dropout_rate.toFixed(0)}% de
                  abandono en este curso
                </p>
                <p className='text-muted-foreground text-xs'>
