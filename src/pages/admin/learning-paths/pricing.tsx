    ...
    <div className='space-y-6'>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Define si esta ruta es gratuita o de pago
          </CardDescription>
        </CardHeader>
      ...
      <div className='grid gap-6 md:grid-cols-2'>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Suma de todos los cursos por separado
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className='space-y-2 border-t pt-4'>
              ...
              <div className='flex justify-between'>
                ...
                <span className='text-green-600'>
                  -$
                  {((totalIndividualPrice * discountPercentage) / 100).toFixed(
                    2
                  )}
                </span>
              </div>
          ...
          {isFree ? (
            ...
            <>
              ...
              {discountPercentage > 0 &&
                !useCustomPrice &&
                `Ahorro de $${((totalIndividualPrice * discountPercentage) / 100).toFixed(2)} (${discountPercentage}% de descuento).`}
            </>
          )}
        </AlertDescription>
      </Alert>
