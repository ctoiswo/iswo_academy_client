  ...
  return (
    <div className="container mx-auto py-8">
      <div className="mb-6">
        ...
        <p className="text-gray-600">Gestiona lecciones, secciones y contenido del curso</p>
      </div>
        ...
        <CardHeader>
          <div className="flex justify-between items-center">
            <div>
              ...
              <CardDescription>
                {course.lessons_count || 0} lección{course.lessons_count !== 1 ? 'es' : ''} • {course.sections_count || 0} sección{course.sections_count !== 1 ? 'es' : ''}
              </CardDescription>
            </div>
            <Button>
