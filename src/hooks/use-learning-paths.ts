...
export function useLearningPath(
  ...
  return useQuery({
    ...
    queryFn: () =>
      learningPathService.getLearningPathBySlug(academySlug, slugOrId),
...
export function useUpdateLearningPath(academySlug: string) {
  ...
  return useMutation({
    ...
    onSuccess: (_, variables) => {
      ...
      queryClient.invalidateQueries({
        queryKey: ['learning-path', variables.learningPathSlug],
      })
...
export function useUpdateLearningPathSettings(
  academySlug: string,
  learningPathSlug: string
) {
  const queryClient = useQueryClient()
...
export function useLearningPathAnalytics(
  academySlug: string,
  learningPathSlug: string
) {
  return useQuery({
    ...
    queryFn: () =>
      learningPathService.getLearningPathAnalytics(
        academySlug,
        learningPathSlug
      ),
