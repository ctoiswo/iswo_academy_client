...
export function StudentProgress({ 
  ...
  const filteredStudents = students.filter(student => {
    if (selectedCourse !== 'all' && student.course.id.toString() !== selectedCourse) {
      return false
    }
    ...
    action: (
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          <DropdownMenuItem onClick={() => onViewProgress?.(student.student.id, student.course.id)}>
          ...
          <DropdownMenuItem onClick={() => onMessageStudent?.(student.student.id)}>
