...
function StatTile({
  ...
  return (
    <div className='border-border/60 bg-card hover:border-primary/30 flex items-start gap-3 rounded-xl border p-4 transition-all hover:shadow-[0_0_20px_rgba(99,102,241,0.06)]'>
      <div
        className={cn(
    ...
    <div className='grid grid-cols-2 gap-3 lg:grid-cols-4'>
      <StatTile
        ...
        trend={{
          ...
          label: t('super_admin.stats.newThisMonth', {
            count: stats?.new_academies_this_month ?? 0,
          }),
        }}
      ...
      <StatTile
        ...
        trend={{
          ...
          label: t('super_admin.stats.newThisMonth', {
            count: stats?.new_users_this_month ?? 0,
          }),
        }}
      />
