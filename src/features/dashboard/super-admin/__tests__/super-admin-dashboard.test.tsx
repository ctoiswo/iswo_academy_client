...
describe('SuperAdminDashboard', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    it('renders dashboard title and description', () => {
      ...
      expect(screen.getByText('Manage all academies and system-wide settings')).toBeInTheDocument()
    })
    ...
    it('returns null when user is not provided', () => {
      const { container } = render(<SuperAdminDashboard user={null} academy={mockAcademy} />)
  ...
  describe('Loading States', () => {
    ...
    it('shows loaded data after loading completes', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('Stats loaded: 12 academies')).toBeInTheDocument()
      }, { timeout: 2000 })
      
      await waitFor(() => {
        expect(screen.getByText('Academies loaded: 3 items')).toBeInTheDocument()
      }, { timeout: 2000 })
    })
  })
