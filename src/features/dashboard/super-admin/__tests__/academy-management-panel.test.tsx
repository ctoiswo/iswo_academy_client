...
describe('AcademyManagementPanel', () => {
  ...
  describe('Basic Rendering', () => {
    it('renders dashboard card with correct title and description', () => {
      ...
      expect(screen.getByTestId('card-title')).toHaveTextContent('Academy Management')
      expect(screen.getByTestId('card-description')).toHaveTextContent('Manage all academies on the platform')
    })
    ...
    it('renders search input', () => {
      ...
      expect(screen.getByPlaceholderText('Search academies...')).toBeInTheDocument()
    })
  ...
  describe('Academy Table', () => {
    ...
    it('renders academy data in table rows', () => {
      ...
      expect(screen.getByText('Leading technology education platform')).toBeInTheDocument()
      expect(screen.getByText('Business School')).toBeInTheDocument()
      expect(screen.getByText('Professional business training')).toBeInTheDocument()
      expect(screen.getByText('Design Institute')).toBeInTheDocument()
      expect(screen.getByText('Creative design and arts education')).toBeInTheDocument()
    })
  ...
  describe('Search Functionality', () => {
    ...
    it('shows no results message when search has no matches', () => {
      ...
      expect(screen.getByText('No academies match your filters')).toBeInTheDocument()
  ...
  describe('Loading State', () => {
    ...
    it('does not show academy data when loading', () => {
      render(<AcademyManagementPanel academies={mockAcademies} loading={true} />)
  ...
  describe('Error State', () => {
    it('shows error message when error is provided', () => {
      ...
      expect(screen.getByText(`Error loading academies: ${errorMessage}`)).toBeInTheDocument()
    })

    it('does not show academy table when error is present', () => {
      render(<AcademyManagementPanel academies={mockAcademies} error="Some error" />)
