...
describe('LearningProgress', () => {
  it('renders loading state correctly', () => {
    render(
      <LearningProgress progressData={[]} stats={mockStats} loading={true} />
    )
  ...
  it('renders progress overview cards correctly', () => {
    render(
      <LearningProgress progressData={mockProgressData} stats={mockStats} />
    )
  ...
  it('renders chart widgets correctly', () => {
    ...
    expect(
      screen.getByText('Progress across your enrolled courses')
    ).toBeInTheDocument()

    expect(screen.getByText('Weekly Study Hours')).toBeInTheDocument()
    expect(
      screen.getByText('Your study time over the past week')
    ).toBeInTheDocument()
  })
  ...
  it('renders detailed progress list correctly', () => {
    ...
    expect(
      screen.getByText('Detailed breakdown of your learning progress')
    ).toBeInTheDocument()
  ...
  it('calculates active courses correctly', () => {
    ...
    render(
      <LearningProgress
        ...
        stats={statsWithDifferentValues}
      />
    )
  ...
  it('truncates long course titles in chart data', () => {
    ...
    render(
      <LearningProgress progressData={longTitleProgress} stats={mockStats} />
    )
