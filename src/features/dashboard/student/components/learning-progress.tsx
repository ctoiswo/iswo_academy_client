...
export function LearningProgress({ 
  ...
  const chartData = progressData.map(progress => ({
    name: progress.course_title.length > 15 
        ...
        <DashboardCard size="sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold">{Math.round(stats.average_progress)}%</p>
        ...
        <DashboardCard size="sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold">{stats.total_enrollments - stats.completed_courses}</p>
              <p className="text-xs text-muted-foreground mt-1">
                in progress
              </p>
            </div>
