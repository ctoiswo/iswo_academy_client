...
vi.mock('../components', () => ({
  ...
  CourseManagementPanel: () => (
    <div data-testid='course-management-panel'>Course Management</div>
  ),
  UserManagementPanel: () => (
    <div data-testid='user-management-panel'>User Management</div>
  ),
}))
...
describe('AcademyAdminDashboard', () => {
  ...
  it('should render dashboard layout when user and academy are provided', () => {
    ...
    expect(
      screen.getByText("Manage your academy's students, teachers, and courses")
    ).toBeInTheDocument()
  })
  ...
  it('should show overview tab content by default', () => {
    ...
    expect(
      screen.queryByTestId('course-management-panel')
    ).not.toBeInTheDocument()
    expect(
      screen.queryByTestId('user-management-panel')
    ).not.toBeInTheDocument()
  })
  ...
  it('should switch to courses tab when clicked', async () => {
    ...
    await waitFor(() => {
      ...
      expect(
        screen.queryByTestId('academy-stats-overview')
      ).not.toBeInTheDocument()
      expect(
        screen.queryByTestId('user-management-panel')
      ).not.toBeInTheDocument()
