            ...
            <FormItem className='flex flex-col gap-2'>
              ...
              <FormControl>
                <Input
                  ...
                  className='bg-secondary/50 border-border focus-visible:border-primary focus-visible:ring-primary/20 placeholder:text-muted-foreground/50 h-11 transition-all duration-300'
                  {...field}
                />
              </FormControl>
              <FormMessage />
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className='flex flex-col gap-2'>
              ...
              <FormControl>
                <Textarea
                  placeholder={t('createAcademy.fields.descriptionPlaceholder')}
                  rows={4}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className='flex flex-col gap-2'>
              ...
              >
                <FormControl>
                  <SelectTrigger className='bg-secondary/50 border-border focus-visible:border-primary focus-visible:ring-primary/20 h-11 w-full transition-all duration-300'>
                    <SelectValue
                      placeholder={t(
