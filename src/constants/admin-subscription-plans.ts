...
export const ADMIN_SUBSCRIPTION_PLANS: AdminSubscriptionPlan[] = [
  {
    code: 'starter',
    name: 'Starter',
    description: 'Ideal para academias que estan comenzando y quieren lanzar rapido.',
    price: 500000,
    features: [
  ...
  },
  {
    code: 'pro',
    name: 'Pro',
    description: 'Para academias que buscan una presencia mas solida y crecimiento continuo.',
    price: 900000,
    badge: 'Recomendado',
    features: [
      'Academia activa por 1 ano',
