...
export const CATEGORY_VISUAL_CONFIG: Record<string, CategoryVisualConfig> = {
  ...
  programacion: {
    ...
    tagline: 'Construye cualquier cosa con código',
  },
  'diseno-grafico': {
    icon: 'PenTool',
    accentFrom: 'from-pink-500',
    accentTo: 'to-rose-400',
    tagline: 'Del boceto a la obra maestra',
  },
  'marketing-digital': {
    icon: 'TrendingUp',
    accentFrom: 'from-orange-500',
    accentTo: 'to-amber-400',
    tagline: 'Impulsa tu presencia online',
  },
  negocios: {
    icon: 'Briefcase',
  ...
  cocina: {
    ...
    tagline: 'Descubre el arte culinario',
  },
  idiomas: {
    icon: 'Globe',
    accentFrom: 'from-teal-500',
    accentTo: 'to-cyan-400',
    tagline: 'Abre puertas con nuevos idiomas',
  },
  musica: {
    icon: 'Music',
    accentFrom: 'from-violet-600',
    accentTo: 'to-purple-400',
    tagline: 'Expresa tu talento musical',
  },
  fitness: {
    icon: 'Dumbbell',
    accentFrom: 'from-emerald-600',
    accentTo: 'to-green-400',
    tagline: 'Transforma tu cuerpo y tu mente',
  },
  fotografia: {
    icon: 'Camera',
    accentFrom: 'from-amber-600',
    accentTo: 'to-yellow-500',
    tagline: 'Captura el mundo con tu lente',
  },
  'desarrollo-personal': {
    icon: 'Brain',
    accentFrom: 'from-indigo-600',
    accentTo: 'to-violet-500',
    tagline: 'Crece y supera tus límites',
  },
  ...
  'arte-y-diseno': {
    ...
    tagline: 'Crea experiencias visuales únicas',
  },
  ciencias: {
    icon: 'FlaskConical',
    accentFrom: 'from-purple-600',
    accentTo: 'to-fuchsia-400',
    tagline: 'Explora el mundo científico',
  },
  educacion: {
    icon: 'GraduationCap',
    accentFrom: 'from-lime-600',
    accentTo: 'to-green-500',
    tagline: 'Transforma el aprendizaje',
  },
  'salud-y-bienestar': {
    icon: 'Heart',
